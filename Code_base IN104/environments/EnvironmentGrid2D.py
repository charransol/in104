...
class EnvironmentGrid2D(Environment):
    ...
    def __init__(self,params):
        ...
        self.num_states=n #crée une grille de longeur l de largeur w en fct de numcellesgrid
        self.h=h
        self.w=w
        print(w)
        print(h) #attention la génération de grille de taille aléatoire ne marche pas!!!
